...
router.get("/deleteProduct/:id", verifyLogin.verifyLoginAdmin, adminLogin.deleteProduct);
router.get("/userDetails",verifyLogin.verifyLoginAdmin, adminLogin.userDetails);
router.get("/blockuser/:id", verifyLogin.verifyLoginAdmin, adminLogin.blockuser);
router.get("/unblockuser/:id", verifyLogin.verifyLoginAdmin, adminLogin.unblockuser);
router.get("/categories", verifyLogin.verifyLoginAdmin, adminLogin.categories);
router.post("/addCategory", verifyLogin.verifyLoginAdmin, adminLogin.addCategory);
router.post("/editCategory/:id", verifyLogin.verifyLoginAdmin, adminLogin.editCategory);
router.get("/deleteCategory/:id", verifyLogin.verifyLoginAdmin, adminLogin.deleteCategory);
